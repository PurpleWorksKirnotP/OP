...
Commands:
  ...
  -ddos <dns> <target>  DDoS payload (hosted on <dns>, hitting <target>)
  -infect <dns> <wifi>  device-infection payload (hosted on <dns>, targeting <wifi>)
